...
<div>
	<h6 style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">Admin</h6>
	<p>Username : admin</p>
	<p>Password : admin123</p>
</div>
<br>
<div>
	<h6 style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">User</h6>
	<p>Username : Mark</p>
